...
const Checkbox = ({ genre, formData, onFormChange }) => {
  return (
   ...
   py-2 px-4 font-bold text-gray-100 transition-colors duration-200 ease-in-out peer-checked:bg-[var(--pink)] peer-checked:text-gray-100 peer-checked:border-gray-200 text-center block'
      >
        {genre.id}
      </label>
    </div>
