  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className='p-2 md:p-4 lg:p-6 xl:p-8 mt-5 xl:mt-20 grid grid-cols-1 auto-rows-max md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-5 sidebar'>
            {shows.length > 0 ? (
